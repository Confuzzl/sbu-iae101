...
USER_FIELDS = ["created_at", "description",
               "pinned_tweet_id", "public_metrics", "url"]
...
def send_tweet(client: tweepy.Client = None, msg=""):
...
def send_quote_tweet(client: tweepy.Client = None, msg="", tweet_id=None):
...
def send_reply_tweet(client: tweepy.Client = None, msg="", tweet_id=None):
...
def send_media_tweet(client: tweepy.Client = None, msg="", filename=""):
...
def send_reply_media_tweet(client: tweepy.Client = None, msg="", tweet_id=None, filename=""):
...
def retweet(client: tweepy.Client = None, tid=None):
...
def get_tweet(client: tweepy.Client = None, tid=None):
...
def get_retweeters(client: tweepy.Client = None, tid=None, count=1):
...
def get_home_timeline(client: tweepy.Client = None, count=1):
...
def get_users_tweets(client: tweepy.Client = None, user_name="", count=5):
...
def get_users_mentions(client: tweepy.Client = None, user_name="", count=5):
...
def get_user(client: tweepy.Client = None, *, user_name="", user_id=""):
...
def search_tweets(client: tweepy.Client = None, query="", count=10):
