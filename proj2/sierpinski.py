...
def sierpinski(degree, p1, p2, p3, color, line_width, screen):
    ...
    sierpinski(degree-1, p1, a, c, color, line_width, screen)
    sierpinski(degree-1, a, p2, b, color, line_width, screen)
    sierpinski(degree-1, c, b, p3, color, line_width, screen)
